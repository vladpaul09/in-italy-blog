...
const DateCalendarMobile: FC<Props> = ({ startDate, setStartDate, endDate, setEndDate, setEntireDate, handleClose }) => {
  ...
  return (
    <Stack direction="column" sx={{ width: "min-content" }}>
...
export default DateCalendarMobile;
