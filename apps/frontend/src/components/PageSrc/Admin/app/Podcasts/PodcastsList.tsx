...
const PodcastsList: FC = () => {
  ...
  filtersArray.push(<ReferenceInput source="category" reference={ResourceType.CategoriesPodcasts} alwaysOn />);
  if (canAccessReview) {
  ...
  return (
    <List filters={filtersArray}>
      <Datagrid rowClick={canAccessEdit ? "edit" : "show"} bulkActionButtons={<BulkDeleteButton mutationMode="optimistic" />}>
        ...
        <ReferenceArrayField source="categories" reference={ResourceType.CategoriesPodcasts} sortable={false} />
