...
import NewsCategoryAutocomplete from "./NewsCategoryAutocomplete";
import LocationButton from "../../components/Buttons/LocationButton";
import CKEditorField from "../../components/Fields/CKEditorField";
import FieldText from "../../components/Fields/FieldText";

const ArticlesForm: FC<{ actionType: "create" | "edit" | "show" }> = ({ actionType }) => {
  ...
  return (
    <Grid container spacing={2}>
      ...
      <Grid size={12}>
        {isShow ? (
          <Labeled>
            <ReferenceArrayField
              source="categories"
              reference={resource === ResourceType.News ? ResourceType.Categories : ResourceType.CategoriesArticles}
            />
          </Labeled>
        ) : (
          <ReferenceArrayInput
            ...
            perPage={config.admin.suggestionLimit}
          >
            {resource === ResourceType.News ? <NewsCategoryAutocomplete /> : <AutocompleteArrayInput optionText="name" />}
          </ReferenceArrayInput>
        )}
      </Grid>
      {canAccess && (
      ...
      <Grid size={12}>
        <LanguageArrayInput source="articleLanguages" isShow={isShow}>
